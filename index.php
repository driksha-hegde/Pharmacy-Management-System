        ...
        <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="total__box text-center">
                                    <h1>
                                        <?php
                                            $query = "SELECT COUNT(*) totalManager FROM medicines;";
                                                $result = mysqli_query( $connection, $query );
            ...
            <div class="manager">
                        ...
                        <div class="main__table">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $getManagers = "SELECT * FROM medicines";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php printf( "%s", $manager['fname'] );?></td>
                                            <td><?php printf( "%s", $manager['type'] );?></td>
                                            <td><?php printf( "%s", $manager['qty'] );?></td>
                                            <td><?php printf( "%s", $manager['company'] );?></td>
                                            <?php if ( 'admin' == $sessionRole ) {?>
                                                <!-- Only For Admin -->
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col col-12">
                                        <label class="input">
                                            ...
                                            <input type="numeric" name="qty" placeholder="Quantity" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <?php if ( 'editManager' == $action ) {
                        ...
                        $selectManagers = "SELECT * FROM medicines WHERE id='{$managerId}'";
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="fname" placeholder="Medicine name" value="<?php echo $manager['fname']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="type" placeholder="Type" value="<?php echo $manager['type']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-envelope"></i>
                                            <input type="numeric" name="qty" placeholder="Quantity" value="<?php echo $manager['qty']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-phone-alt"></i>
                                            <input type="text" name="company" placeholder="Company" value="<?php echo $manager['company']; ?>" required>
                                        </label>
                                    </div>
                ...
                <?php if ( 'deleteManager' == $action ) {
                        $managerId = $_REQUEST['id'];
                        $deleteManager = "DELETE FROM medicines WHERE id ='{$managerId}'";
